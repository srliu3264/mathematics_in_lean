...
example : (a + b) * (c + d) = a * c + a * d + b * c + b * d := by
  calc 
    ...
    _                =  a*c + b*c + a*d + b*d := by rw [add_mul,add_mul, ←add_assoc]
    _                = a*c + (b*c + a*d) + b*d := by rw [←add_assoc]
    _                = a*c + (a*d + b*c) + b*d := by rw [add_comm (a*d) (b*c)]
    _                = a*c + a*d + b*c + b*d := by rw [add_assoc (a*c) (a*d) (b*c)]
